...
<template>
    <GuestLayout>
        ...
        <div
            class="mb-6 p-4 rounded-xl bg-emerald-50 dark:bg-white/10 border border-emerald-200 dark:border-white/20 text-sm font-semibold text-emerald-600 dark:text-white"
